...
const HeroMarquee = () => {
  return (
    <>
      <div className="absolute blur-[2px] top-[8rem] z-[-10] opacity-[0.1] w-[100vw] 2xl:max-w-[1470px]">
      ...
      <div className="absolute blur-[2px] top-[31rem] z-[-10] opacity-[0.1] w-[100vw] 2xl:max-w-[1470px]">

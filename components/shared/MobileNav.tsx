...
const MobileNav = ({ isOpen }: { isOpen: boolean }) => {
  ...
  return (
    <div ref={container}>
      <div className="menu-overlay flex flex-col justify-between fixed top-0 bottom-0 w-screen h-screen bg-[#5a3ee5] pt-[11rem] md:pt-[9rem] pb-[7rem] px-[2rem] md:px-[6rem] lg:hidden">
